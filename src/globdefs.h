 ...
 * @date 2019
 * @brief Contains global definitions used by Farmafit.
 * 
 * VALUE_NOT_SET is used when we create the head of the linked list, to
 * indicate that no measured values were assigned to it.
 *
